...
function get_avatar_data( $id_or_email, $args = null ) {
	...
	if ( is_ssl() ) {
		$url = 'https://cn-blogs.cn/wp-content/plugins/disable-user-gravatar/default-gravatar.png';
	} else {
		$url = sprintf( 'https://cn-blogs.cn/wp-content/plugins/disable-user-gravatar/default-gravatar.png?', $gravatar_server, $email_hash );
	}
